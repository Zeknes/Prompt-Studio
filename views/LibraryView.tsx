      ...
      <div className="flex justify-between items-end mb-8 flex-shrink-0">
        ...
        <div className="relative group">
          ...
          <input
            ...
            className="bg-white dark:bg-[#1c1c1e] border border-gray-200 dark:border-white/5 rounded-xl pl-10 pr-4 py-2 text-sm w-64 text-gray-900 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all placeholder:text-gray-400 dark:placeholder:text-gray-600 shadow-sm"
          />
        </div>
      </div>
